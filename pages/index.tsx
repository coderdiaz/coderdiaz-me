      ...
      <section className="py-5 mb-4 md:mb-6 lg:mb-11">
        <Container className="max-w-screen-lg">
          ...
          <div className="flex flex-col space-y-1 md:space-y-3 md:mr-24 lg:mr-48 mb-4 md:mb-6">
            ...
            <p className="leading-relaxed md:text-lg lg:text-xl">Interested in <RoughNotation type="highlight" show={true} color="#FFE4E6" iterations={1}>design systems</RoughNotation>, <RoughNotation type="highlight" show={true} color="#FEF9C3">jamstack</RoughNotation> and <RoughNotation type="highlight" show={true} color="#D1FAE5">user/dev</RoughNotation> experience. I love making tools that are user-friendly, simple and delightful. I work as Engineering Manager at <span className="font-semibold">Bedu</span> — focusing on improve our ed-tech process. My goal is create fast, simple and accessible web experiences.</p>
            <p className="leading-relaxed md:text-lg lg:text-xl">I am currently available for <RoughNotation type="highlight" show={true} color="#EDE9FE" iterations={1}>freelance</RoughNotation> and <RoughNotation type="highlight" show={true} color="#CFFAFE" iterations={1}>contract</RoughNotation> work.</p>
          </div>
